...
import { IconChevronDown, IconDashboard, IconHome, IconMoonStars, IconSun, IconBolt } from '@tabler/icons';
...
const navBarItems = [{ link: routes.home, label: 'Home', icon: IconHome }] as const;
      ...
      <Navbar.Section grow>
        {navBarItems.map((item) => (
          <Link href={item.link} passHref key={item.label}>
            <a className={cx(classes.link, { [classes.linkActive]: pathname === item.link })}>
